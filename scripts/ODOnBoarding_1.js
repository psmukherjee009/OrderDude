var global = {
	...
	latitude : -999999,
	longitude : -999999,
	ob_info_onboarding_url:'http://www.orderdude.com/cgi-bin/VirtualOrdering.cgi/ADDINFO/',
	ob_menu_onboard_url : 'http://www.orderdude.com/ODOnboarding_GetMenu.html',
	ophours_max_entry : 10,
	input : {address:{},products:{},op_hours:[]}
};
...
function test_getAddressGeoCode() {
...
function check_text_field (fieldname,defaultvalue) {
	...
	error_msg = error_msg + check_text_field('#res_phone','1-555-555-5555');
	...
	request.onload = function() {
		if (request.status == 200) {
			...
			global.input.id = request.responseText;
		}
	}
...
function gather_values_onboardmerchant_pg1() {
	...
	handle_event('submit_form',global.ob_info_onboarding_url,JSON.stringify(global.input));
}
function onboardmerchant_pg1(Obj) {
	test_getAddressGeoCode();
