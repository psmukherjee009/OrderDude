/*
Version : 4.0
Capability : ['Accept Payment','Streamedlined GET and POST input','IE Fixed','No Maps']
*/
...
var global = {
	Start_Page : -1,
	GetOrderUpdate_Url : '/cgi-bin/VirtualOrdering_4.cgi/GETORDERUPDATE/',
	UpdateOrder_Url : '/cgi-bin/VirtualOrdering_4.cgi/UPDATEORDER/',
	SendNewOrder_Url : '/cgi-bin/VirtualOrdering_4.cgi/SENDNEWORDER/',
	Get_Restaurant_List_Url : '/cgi-bin/VirtualOrdering_4.cgi/GETINFO/',
	Get_Business_Details_Url : '/cgi-bin/VirtualOrdering_4.cgi/GETBUSINESS/',
...
function Page_Payment() {
	...
	var footer_markup = '<a href="https://www.paypal.com/webscr?cmd=_ap-payment&paykey='+global.sRestaurant.Cart.PPKey+'&expType=mini" data-role="button">Pay with PayPal</a>';
