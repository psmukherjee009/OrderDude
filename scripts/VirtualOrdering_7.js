...
var global = {
	Start_Page : -1,
	GetOrderUpdate_Url : '/cgi-perl/VirtualOrdering_7.cgi/GETORDERUPDATE/',
	UpdateOrder_Url : '/cgi-perl/VirtualOrdering_7.cgi/UPDATEORDER/',
	SendNewOrder_Url : '/cgi-perl/VirtualOrdering_7.cgi/SENDNEWORDER/',
	Get_Restaurant_List_Url : '/cgi-perl/VirtualOrdering_7.cgi/GETINFO/',
	Get_Business_Details_Url : '/cgi-perl/VirtualOrdering_7.cgi/GETBUSINESS/',
	Payment_Complete_Url : '/cgi-perl/VirtualOrdering_7.cgi/COMPLETEORDER/',
...
function getOrderPersonalizationItemDisplayBlock(cName_escaped,key,key_escaped,priceObj,elements,i) {
		...
		if ( typeof elements["price"] === "string" ) {	//Case of simple pricing		
				...
				if ( typeof elements.order != 'undefined' ) {
					...
					if ( typeof elements.personalize != 'undefined' ) {
						markup += getOrderPersonalizationItemDisplayBlock(cName_escaped,key,key_escaped,priceObj,elements,i);
					}
					markup += '</label>';
				}
				else {
