...
var restaurant_2 = {
	"Info":{
		...
		"phone":"4084531983",
		"id" : "4084531983",
		"address" : "41 East Gish Road San Jose, CA",
		"coordinates" : {"latitude" : 37.3622033,"longitude" :  -121.90903530000003},
		"logo" : "http://www.menara41.com/go/wp-content/themes/revolution_music-10/images/menara_logo3.png",
		"bkcolor" : "#FCC",
		"Tax" : "8%"
		},
	"Menu":{
...
function editor(obj,namespace) {
	...
	if (typeof obj === 'number')
		return '<input type="text" name="'+namespace+'.'+obj+'" value ="'+obj+'">';
	
	if (typeof obj === 'string')
		return '<input type="text" name="'+namespace+'.'+obj+'" value ="'+obj+'" size="'+obj.length+'">';
	...
	if (typeof obj === 'object') {
		...
		if ( Array.isArray(obj) ) {
			...
			Object.keys(obj).forEach(function(item) {
				markup += '<table>';
				markup += '<tr><td>'+editor(item,namespace+'.name')+'</td><td>'+editor(obj[item],namespace+'.value')+'</td></tr>';
				markup += '</table>';
				//alert('Name = '+editor(item,namespace));
				//alert('Value = '+editor(obj[item],namespace));
			});
...
$(document).ready(function() {
	...
	markup += editor(restaurant_2,'top');
	markup += '</form>';
