...
var global = {
	Start_Page : -1,
	GetOrderUpdate_Url : '/cgi-bin/VirtualOrdering_5.cgi/GETORDERUPDATE/',
	UpdateOrder_Url : '/cgi-bin/VirtualOrdering_5.cgi/UPDATEORDER/',
	SendNewOrder_Url : '/cgi-bin/VirtualOrdering_5.cgi/SENDNEWORDER/',
	Get_Restaurant_List_Url : '/cgi-bin/VirtualOrdering_5.cgi/GETINFO/',
	Get_Business_Details_Url : '/cgi-bin/VirtualOrdering_5.cgi/GETBUSINESS/',
	Payment_Complete_Url : '/cgi-bin/VirtualOrdering_5.cgi/COMPLETEORDER/',
...
function Page_Cart() {
	...
	if ( localStorage.getItem('Name') && localStorage.getItem('Phone') ) { // Have the order inputs so go to orders directly
		...
		if ( typeof global.sRestaurant.Info.no_dinein_orders != 'undefined' ) {
