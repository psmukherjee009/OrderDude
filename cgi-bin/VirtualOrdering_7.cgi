...
sub SendFax {
	...
	# Send the fax now
	my $ret_msg2 = "";
	my $fax_email = "$fax\@myfax.com";
	if ( !$is_live ) {
		$fax_email = "$fax\@parthamukherjee.com";
	}
	#my $cmd2 = "./SendEmail.sh '$fax_email' '' '' $filename";
	my $cmd2 = "./SendEmail.pl orders@orderdude.com -cc partha@parthamukherjee.com '$fax_email' '' '' $filename";
	my $ret_msg2 .= ExecuteCommand($cmd2);
...
<div style="position:absolute;left:227.64px;top:12.92px" class="cls_026"><span class="cls_026">Fax Order Form   |   Charing Cross</span></div>
...
<div style="position:absolute;left:221.21px;top:58.06px" class="cls_017"><span class="cls_017">1</span></div>
<div style="position:absolute;left:243.48px;top:68.56px" class="cls_014"><span class="cls_014">(PLEASE PRINT)</span></div>
<div style="position:absolute;left:49.94px;top:74.08px" class="cls_025"><span class="cls_025">114 - 116 Charing Cross Road</span></div>
<div style="position:absolute;left:64.62px;top:88.48px" class="cls_025"><span class="cls_025">Mon-Sat: 11 am-11 pm</span></div>
<div style="position:absolute;left:218.71px;top:87.13px" class="cls_017"><span class="cls_017">2</span><span class="cls_027"> Complete the form below.</span></div>
<div style="position:absolute;left:384.68px;top:87.13px" class="cls_017"><span class="cls_017">3</span><span class="cls_027"> Fax your order to 020 7836 8468.</span></div>
<div style="position:absolute;left:607.35px;top:87.02px" class="cls_017"><span class="cls_017">4</span><span class="cls_027"> Call 020 7836 8491 to confirm.</span></div>
...
sub print_chipotle_fax_line {
	...
	for ( my $j = 0 ; $j < $quantity; ++$j ) {
		...
		print "<div style=\"position:absolute;left:213.17px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_005\"><span class=\"cls_005\">".($fax_line_no+1_)."</span></div>";
		...
		print "<div style=\"position:absolute;left:457.32px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/F/,@toppings)) ? "F" : "")."</span></div>";
		...
		print "<div style=\"position:absolute;left:558.27px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/M/,@toppings)) ? "M" : "")."</span></div>";
		print "<div style=\"position:absolute;left:572.92px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/MC/,@toppings)) ? "MC" : "")."</span></div>";
		print "<div style=\"position:absolute;left:590.78px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/MG/,@toppings)) ? "MG" : "")."</span></div>";
		print "<div style=\"position:absolute;left:612.71px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/H/,@toppings)) ? "H" : "")."</span></div>";
		print "<div style=\"position:absolute;left:631.05px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/SC/,@toppings)) ? "SC" : "")."</span></div>";
		print "<div style=\"position:absolute;left:658.08px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/C/,@toppings)) ? "C" : "")."</span></div>";
		print "<div style=\"position:absolute;left:684.96px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/G/,@toppings)) ? "G" : "")."</span></div>";
		print "<div style=\"position:absolute;left:715.35px;top:".(178+($fax_line_no*30.8))."px\" class=\"cls_006\"><span class=\"cls_006\">".((grep(/L/,@toppings)) ? "L" : "")."</span></div>";
		$fax_line_no++;
	}
}
...
sub ChipotleFaxOrder {
	...
	if ( $#data >= 0 ) {
		...
		print "<div style=\"position:absolute;left:308.44px;top:68.86px\" class=\"cls_002\"><span class=\"cls_002\">$date</span></div>";
		
		#contact name
		print "<div style=\"position:absolute;left:488.44px;top:68.86px\" class=\"cls_002\"><span class=\"cls_002\">".$order_hash->{"Name"}."</span></div>";
		
		#contact phone
		print "<div style=\"position:absolute;left:608.44px;top:68.86px\" class=\"cls_002\"><span class=\"cls_002\">".$order_hash->{"Phone"}."</span></div>";
...
sub Order2pdf {
	...
	Info("Bad ID","ID needs to be numeric",$cmd[2]." is not numeric") if ($cmd[2] !~ /^[+-]?\d+$/);
	my $order_id = $cmd[2];
	my $cmd = "./pdfcrowd.sh http://www.orderdude.com/cgi-perl/VirtualOrdering.cgi/CHIPOTLEFAXORDER/$order_id\/ > ../pdforders/$order_id\.pdf";
	#my $cmd = "ls";
	#Remove Taint Mode
...
sub EmailOrder {
	...
	my $cmd2 = "./SendEmail.sh partha\@parthamukherjee.com '' '' $filename";
	my $ret_msg2 .= ExecuteCommand($cmd2);
