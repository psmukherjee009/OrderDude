...
var global = {
	frontpagepitch : "<h3>Chipotle in OrderDude.<br /><br />More coming ..</h3>",
	Start_Page : -1,
...
function getMyLocation() {
	...
	alert("Started getMyLocation");
    if (navigator.geolocation) {
		console.log("Geolocation Present");
		alert("Geolocation Present");
...
function displayLocation(position) {
	...
	alert("Position Co-ordinates :: LATITUDE "+position.coords.latitude+" LONGITUDE "+position.coords.longitude);
...
function ops_Find() {
	...
	getMyLocation();
	alert("Started Find");
	//stintvl = setInterval(getMyLocation,1000);
}
