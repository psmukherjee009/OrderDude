...
var global = {
	frontpagepitch : "<h3>Chipotle in OrderDude. More coming ..</h3>",
	Start_Page : -1,
...
function getMyLocation() {
    ...
    if (navigator.geolocation) {
		console.log("At getMyLocation : Current Position Latitude "+global.latitude);
        navigator.geolocation.getCurrentPosition(displayLocation,displayAddressInput);
    } else {
		console.log("At getMyLocation : No Current Position");
        displayAddressInput();
    }
}
