...
function Page_Home() {
	...
	console.log('PreviousOrdersList = ' + PreviousOrdersList());
...
$(document).ready(function() {
	console.log('start $(document).ready(function()');
	//alert("Document Base URL "+document.URL);
	if ( (!document.URL) || ( document.URL.indexOf("orderdude.com") == -1) 	) {
		console.log("Reloading Home");
		window.location.href = "http://www.orderdude.com";
	}
	global.Input = Array();
	$(document).bind( "pagebeforechange", function( e, data ) {
		console.log("URL for change = "+document.URL);
	...
	console.log("document.ready URL = "+document.URL);
	...
	if ( typeof global.Input['id'] != 'undefined' ) { // Asking for Restaurant Page
		...
		console.log("Set Start Page to "+global.Start_Page);
		...
		console.log("Loading Home: " + window.location.href);
		Page_Home();
	}
});
